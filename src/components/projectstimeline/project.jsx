 ...
 <ImageEvent
          ...
          >
            <div className="d-flex justify-content-between flex-column mt-1">
              <div>
                <Accordion>
                  <Card>
                    ...
                    <Accordion.Collapse eventKey="0" className="text-left">
                      <Card.Body>
                        <strong>Description:</strong> An Blog website using HTML,CSS,
                        JS
                        <hr />
                        <strong>Features:</strong>
                        <ul className="list-styles pt-1">
              ...
              <div className="d-flex justify-content-between flex-nowrap text-center">
                <UrlButton
                  href="https://amit8830.github.io/blogwebsite/"
                  target="_blank"
                >
                  SEE LIVE
                </UrlButton>
                <UrlButton
                  href="https://github.com/Amit8830/blogwebsite/tree/master"
                  target="_blank"
                >
                  SOURCE CODE
                </UrlButton>
